...
class WCS_Email_Cancelled_Subscription extends WC_Email {
	...
	function get_content_html() {
		...
		$end_of_prepaid_term = wp_next_scheduled( 'scheduled_subscription_end_of_prepaid_term', array( 'user_id' => (int)$order->user_id, 'subscription_key' => $this->subscription_key ) );
