...
<div id="message" class="error">
	<p><?php printf( __( '%sWooCommerce Subscriptions is inactive.%s The %sWooCommerce plugin%s must be active for the WooCommerce Subscriptions to work. Please %sinstall & activate WooCommerce%s', 'woocommerce-subscriptions' ), '<strong>', '</strong>', '<a href="http://wordpress.org/extend/plugins/woocommerce/">', '</a>', '<a href="' . admin_url( 'plugins.php' ) . '">', '&nbsp;&raquo;</a>' ); ?></p>
</div>
<?php	endif;
	}
...
<?php
	...
	public static function get_subscriptions( $args = array() ) {
		...
		switch ( $args['order'] ) {
			case 'status' :
				$args['order'] = '_subscription_status';
				break;
			case 'start_date' :
				$args['order'] = '_subscription_start_date';
				break;
			case 'expiry_date' :
				$args['order'] = '_subscription_expiry_date';
				break;
			case 'trial_expiry_date' :
				$args['order'] = '_subscription_trial_expiry_date';
				break;
			case 'end_date' :
				$args['order'] = '_subscription_end_date';
				break;
		}
