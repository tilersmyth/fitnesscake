    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo esc_url( home_url( '/user' ) ); ?>"><?php echo get_bloginfo( 'name' ); ?></a>
        </div>
          ...
          <ul class="nav navbar-nav navbar-right hidden-xs">
            <?php $current_user = wp_get_current_user();?>
              ...
              <ul class="dropdown-menu user_menu">
                ...
                <li><a href="<?php echo esc_url( home_url( '/my-account' ) ); ?>"><span class="glyphicon glyphicon-user user_menu_icon"></span> My Account</a></li>                
